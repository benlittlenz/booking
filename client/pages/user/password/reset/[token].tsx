...
function ResetPassword(props: any) {
  ...
  const submit = async (): Promise<void> => {
    ...
    const res: any = await props.resetPassword(formData.email, formData.password, token);
      ...
      <div className="absolute w-full md:w-3/5 lg:w-1/3 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        >
          <>
            ...
            {formData.error && <Alert type="danger">{formData.error}</Alert>}
            ...
            <p>
              You now have the possibility to reset your password. Firstly, please confirm your
              email address and then create a new password.
            </p>
