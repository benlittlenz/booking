...
export function Navbar(): ReactElement {
  ...
  const sidebarOffset: string = `${
    showSidebar ? "right-0" : "-right-full md:-right-1/2 lg:-right-1/3 xl:-right-1/4"
  }`;
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-end w-full pb-8 cursor-pointer" onClick={toggleNavbar}>
          <svg
        ...
        <NavbarMenuLink title="Documentation" link="/docs" onClick={toggleNavbar} />
        <NavbarMenuLink title="Blog" link="/blog" onClick={toggleNavbar} />
        <NavbarMenuLink title="Contact" link="/contact" onClick={toggleNavbar} />
      </div>
    </>
  );
}
